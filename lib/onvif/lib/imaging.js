    ...
    this._request(
      {
        ...
        body:
          ...
          (options.brightness ? '<Brightness xmlns="http://www.onvif.org/ver10/schema">' + options.brightness + "</Brightness>" : "") +
          (options.colorSaturation
            ? '<ColorSaturation xmlns="http://www.onvif.org/ver10/schema">' + options.colorSaturation + "</ColorSaturation>"
            : "") +
          (options.contrast ? '<Contrast xmlns="http://www.onvif.org/ver10/schema">' + options.contrast + "</Contrast>" : "") +
          (options.exposure
            ? '<Exposure  xmlns="http://www.onvif.org/ver10/schema">' +
              (options.exposure.mode ? '<Mode xmlns="http://www.onvif.org/ver10/schema">' + options.exposure.mode + "</Mode>" : "") +
              ...
              (options.exposure.exposureTime
                ...
                : "") +
              (options.exposure.gain ? '<Gain xmlns="http://www.onvif.org/ver10/schema">' + options.exposure.gain + "</Gain>" : "") +
              (options.exposure.iris ? '<Iris xmlns="http://www.onvif.org/ver10/schema">' + options.exposure.iris + "</Iris>" : "") +
              "</Exposure>"
            : "") +
          (options.focus
            ? '<Focus xmlns="http://www.onvif.org/ver10/schema">' +
              ...
              "</Focus>"
            : "") +
          (options.sharpness ? '<Sharpness xmlns="http://www.onvif.org/ver10/schema">' + options.sharpness + "</Sharpness>" : "") +
          "</ImagingSettings>" +
          "</SetImagingSettings>" +
          this._envelopeFooter(),
      },
